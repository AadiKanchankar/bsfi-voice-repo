...
// Customers the seed script renders enrolment audio for.
const SEEDED_VOICES = ['CUST1000', 'CUST1001', 'CUST1002']
...
export default function Customer() {
  ...
  const [customerId, setCustomerId] = useState('CUST1000')
  ...
  const start = async () => {
    ...
    try {
      const out = await api.startSession({
        ...
        voice_clip: attachVoice && SEEDED_VOICES.includes(customerId)
          ? `${customerId}_0.wav` : null,
        accepted: true,
      })
            ...
            <>
              ...
              <div className="row" style={{ marginBottom: 8 }}>
                <select value={customerId} onChange={(e) => setCustomerId(e.target.value)}>
                  <option value="CUST1000">CUST1000, has a seeded voice</option>
                  <option value="CUST1001">CUST1001, has a seeded voice</option>
                  <option value="CUST1002">CUST1002, has a seeded voice</option>
                  <option value="CUST1005">CUST1005, no seeded voice, enrol your own</option>
                </select>
              </div>
              <label className="muted" style={{ display: 'block', marginBottom: 8 }}>
                ...
                {!SEEDED_VOICES.includes(customerId) && ' (this customer has none, enrol your own voice instead)'}
              </label>
